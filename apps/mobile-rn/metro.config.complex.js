...
// Set the correct entry point for the app
config.resolver.mainFields = ['react-native', 'browser', 'main'];
config.resolver.resolverMainFields = ['react-native', 'browser', 'main'];

// Override the entry point to use the local index.js
config.serializer = {
  ...config.serializer,
...
// Set the entry point explicitly - remove conflicting alias
