...
export const propertyData: Record<string, PropertyDetails> = {
  ...
  "7": {
    id: "7",
    name: "112 West 18th Street (Brooks-Van Horn)",
    address: "113 WEST 17 STREET",
    assessedValue: 4653000,
    marketValue: 10340000,
    marketValuePerSqFt: 414,
    yearBuilt: "1982",
    numFloors: 6,
    buildingClass: "R4",
    lotArea: 6000,
    buildingArea: 25000,
    residentialArea: 22000,
    commercialArea: 3000,
    unitsResidential: 15,
    unitsCommercial: 1,
    unitsTotal: 16,
    ...
    neighborhood: "Chelsea",
    ownershipType: "Condo",
    ownerName: "BROOKS-VAN HORN CONDOMINIUM"
  },
  "9": {
    id: "9",
    name: "117 West 17th Street (Brooks-Van Horn)",
    address: "113 WEST 17 STREET",
    assessedValue: 5935034,
    marketValue: 13188964,
    marketValuePerSqFt: 528,
    yearBuilt: "1982",
    numFloors: 6,
    buildingClass: "R4",
    lotArea: 6000,
  ...
  "14": {
    ...
    assessedValue: 5964750,
    marketValue: 13255000,
    marketValuePerSqFt: 295,
    yearBuilt: "1900",
    yearRenovated: "1985",
    numFloors: 6,
    buildingClass: "P7",
    lotArea: 9000, // Combined 4 buildings
    buildingArea: 45000, // Combined 4 buildings
    residentialArea: 0,
    commercialArea: 45000,
    unitsResidential: 0,
    unitsCommercial: 4, // 4 physical buildings
    unitsTotal: 4,
    zoning: "C6-2A",
    builtFAR: 5.00,
    maxFAR: 6.50,
