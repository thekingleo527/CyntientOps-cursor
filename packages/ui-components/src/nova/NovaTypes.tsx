...
export default {
  ...
  isContextExpired,
  isPromptExpired,
  isPromptHighPriority,
  hasCriticalInsights,
  getInsightsByPriority,
  isAggregatedDataExpired,
  calculateCompletionPercentage,
  hasCriticalIssues,
  getNovaActionTypeIcon,
  getNovaContextTypeIcon,
  getWorkspaceModeDisplayName,
  getWorkspaceModeIcon,
  getPromptFocusDisplayName,
  ...
  DEFAULT_NOVA_CONTEXT,
  DEFAULT_NOVA_PROMPT,
  DEFAULT_NOVA_RESPONSE,
  DEFAULT_NOVA_ACTION,
  DEFAULT_NOVA_AGGREGATED_DATA,
  DEFAULT_NOVA_EMERGENCY_REPAIR_STATE,
  NOVA_CONSTANTS,
};
